...
## Phase 9: 软著申请材料 (P2)
- [x] 9.1 源代码前 30 页 Word 文档生成 — `scripts/generate-copyright-doc.py` 按项目骨架→基础设施→业务 API→前端组件顺序读取；全局脱敏敏感信息；A4/50 行/页、页眉页脚页码、文件分隔与续接标记；输出 `/mnt/agents/output/软著材料/源代码前30页.docx`（2026-06-12）
- [x] 9.2 脱敏规则 — API Key / Bearer Token / Secret / 数据库连接字符串 / 邮箱 / 手机号 / 身份证号 / URL 凭证统一替换为占位符（2026-06-12）
- [x] 9.3 格式校验 — 30 页、1500 行、Microsoft Word 2007+、页眉「AI影视全流程工作流系统 V1.0」、页脚「第 X 页 共 Y 页」（2026-06-12）
- [ ] 9.4 人工复核 — 打开 Word 确认排版、续接标记、页码、脱敏完整性
